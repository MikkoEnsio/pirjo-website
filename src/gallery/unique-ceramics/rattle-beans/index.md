...
<div class="gallery-grid">
  <a href="#" onclick="openLightbox(0); return false;"><img style="object-position: 50% 50%;" src="/assets/images/unique-ceramics/rattle-beans/helisevat-pavut.jpg" alt="helisevat pavut"></a>
</div>
...
<script>
  const galleryImages = [
    "/assets/images/unique-ceramics/rattle-beans/helisevat-pavut.jpg"
  ];
  const galleryTitles = [
    "helisevat pavut"
  ];
